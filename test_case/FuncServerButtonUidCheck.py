...
@Software:   TestCase
@File    :   FuncServerButtonUidCheck.py
@Time    :   2023/5/7
@Version :   1.0
@License :   Copyright ©LuxShare  2022 . All Rights Reserved.
@Desc    :   功能检查/机头Button 测试/UID Button
'''
import os
import sys
...
class FuncServerButtonUidCheck(TempItem):
    ...
    def __init__(self, options):
        super().__init__()
        self.name = "server uid button"
        self.expect = "This is server uit button function check test on the server"
...
if __name__ == '__main__':
    TempRun.set_item(FuncServerButtonUidCheck)
