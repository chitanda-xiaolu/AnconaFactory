...
@Software:   TestCase
@File    :   FuncJbogHealthLedCheck.py
@Time    :   2023/5/6
@Version :   1.0
...
class FuncJbogHealthLedCheck(TempItem):
    ...
    def __init__(self, options):
        super().__init__()
        self.name = "JBOG health led"
        self.expect = "This is JBOG health led function check test"
    ...
    def exe(self):
        ...
        self.sleep(2)
        tips = self.tips_msg("请查看机尾健康灯! (G/g: 健康灯Pass, R/r: 健康灯Fail)")
...
if __name__ == '__main__':
    TempRun.set_item(FuncJbogHealthLedCheck)
